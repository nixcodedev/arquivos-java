...
public class ApachePoi {
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File("/home/nino/git/arquivos-java/arquivos-java/src/arquivos/aquivo_excel.slx");
		...
		HSSFSheet linhasPessoa = hssfWorkbook
				.createSheet("Planilha de pessoas JDev Treinamento"); /* Criar a planilha */
